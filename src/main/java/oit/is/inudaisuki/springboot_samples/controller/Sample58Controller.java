...
import oit.is.inudaisuki.springboot_samples.service.AsyncCountFruit58;
...
public class Sample58Controller {
  ...
  @Autowired
  private AsyncCountFruit58 ac58;
  ...
  public SseEmitter pushFruit() {
    ...
    this.ac58.pushFruit(sseEmitter);
    return sseEmitter;
